	...
	<nav class="navbar navbar-expand-lg navbar-light bg-secondary">
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mr-auto ml-5">
				<li class="nav-item active"><a class="nav-link text-white font-weight-bold"
					href="detail/${uid }">Profile <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item active ml-5"><a class="nav-link text-white font-weight-bold"
	...
	<c:forEach items="${allCourses }" var="p">
		<div class="card d-inline-flex ml-5 mr-5 mt-5" style="width: 18rem;">
			...
			<div class="card-body">
				...
				<a href="${pageContext.request.contextPath }/userenroll/${uid}/${p.cid}/${p.instructor_id }"
